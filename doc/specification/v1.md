...
-   **Transcription-Tags:** `string`. Optional tags in format "name:COLOR;name:COLOR;", COLOR is optional RRGGBB Hex-code
...
-   Convention: Speakers: Integer `"sp"` key determines the speaker number. A value of 0 implies a monologue (complete absence of other speakers). If there is more than one speaker, the numbering must start from 1 (1, 2, 3, ... implies the presence of multiple speakers).
