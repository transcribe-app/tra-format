...
class ID3Tag {
  ...
  /// Gets the unsynchronized lyric/text transcription ('USLT') frame, represented as a [LyricsUSLT] object.
  List<LyricsUSLT> get lyricsUSLT => framesWithTypeAndName<LyricsUSLT>('USLT');
  /// Gets the synchronized lyric/text transcription ('SYLT') frame, represented as a [LyricsSYLT] object.
  List<LyricsSYLT> get lyricsSYLT => framesWithTypeAndName<LyricsSYLT>('SYLT');
